...
-->volumeMounts defines how the volume is mounted, including the file path by which the volume will be available from inside the container.It is essential that the same.<br>
